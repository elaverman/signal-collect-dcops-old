...
//  graph.addVertex(new DSANVertex(3, 0, Array(c13, c23, c35, c34), Array(0, 1, 2)))
//  graph.addVertex(new DSANVertex(4, 0, Array(c34, c45), Array(0, 1, 2)))
//  graph.addVertex(new DSANVertex(5, 0, Array(c35, c45, c56), Array(0, 1, 2)))
//  graph.addVertex(new DSANVertex(6, 0, Array(c26, c56), Array(0, 1, 2)))
//
